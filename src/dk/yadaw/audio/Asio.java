...
public class Asio {
	...
	/**
	 * Loads driver and initialize ASIO system. On success internal info on
	 * samplerate etc is fetched from asio subsystem.
	 * 
	 * @param driverName ASIO driver name from the collection obtained with
	 *                   getDrivers().
	...
	/**
	 * Connect input stream to the device output channel. On ASIO buffer switch the
	 * audioSync method of the stream will be called.
	 * 
	 * @param ch       Asio Device output channel
	 * @param inStream Samples to the device analog out will be read from this
	 *                 stream by the Asio class.
	...
	/**
	 * Connect AudioStream to the device input channel. On ASIO buffer switch the
	 * audioSync method of the stream will be called.
	 * 
